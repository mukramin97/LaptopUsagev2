      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="filterNISN" name="filterNISN" class="form-control" placeholder="Masukkan NISN Siswa">
            </div>
            <div class="col-md-4">
                <label for="filterNISNKembali">Input Pengembalian</label>
                <input type="text" id="filterNISNKembali" name="filterNISNKembali" class="form-control" placeholder="Masukkan NISN Siswa" disabled>
            </div>
                ...
                { data: 'action', name: 'action', orderable: false, searchable: false,
                    render: function(data, type, full, meta){
                        if(full.tanggal_pinjam != null && full.tanggal_kembali == null){
                            return '<button class="btn btn-success btn-sm custom-action-kembalikan" data-id_penggunaan="'+full.id_penggunaan+'">Kembalikan</button>';
                        }
                        else{
                            return '<button class="btn btn-primary btn-sm custom-action-pinjam" data-id="'+full.id+'">Pinjam</button>';
                        }
