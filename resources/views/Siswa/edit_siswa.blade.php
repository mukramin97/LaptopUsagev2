            ...
            <div class="col">
              <form action="{{ route('siswa.update',$editSiswa->id) }}" method="post" id="edit_siswa">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama"value="{{ $editSiswa->nama }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="merk" name="merk" class="form-control" placeholder="Merk Laptop" value="{{ $editSiswa->laptop->merk }}">
                  <span class="text-danger error-text merk_error"></span>
                </div>
                <div class="form-group">
                  <label for="spesifikasi">Spesifikasi</label>
                  <input class="form-control" name="spesifikasi" id="spesifikasi" rows="2" placeholder="Spesifikasi Laptop" value="{{ $editSiswa->laptop->spesifikasi }}">
