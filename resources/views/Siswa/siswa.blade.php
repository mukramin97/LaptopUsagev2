    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-1">
          ...
          <button id="importSiswa" class="btn btn-info" style="width: 100%" data-toggle="modal" data-target="#exampleModal">Import</button>
        </div>
        <div class="col-md-1">
        ...
        columns: [
            ...
            { data: 'action', name: 'action', orderable: false, searchable: false,
                render: function(data, type, full, meta){
                    return  '<button class="btn btn-primary btn-sm custom-action-edit" data-id_edit="'+full.id+'" onclick="window.location=\'siswa/'+full.id+'/edit\';">Edit</button>' + 
