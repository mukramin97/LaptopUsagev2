...
@section('content')
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <input type="date" id="startDate" name="startDate" class="form-control" placeholder="Masukkan Tanggal Awal">
          </div>
          <div class="col-md-2">
            <label for="startDate">Tanggal Selesai</label>
            <input type="date" id="endDate" name="endDate" class="form-control" placeholder="Masukkan Tanggal Akhir">
          </div>
          <div class="col-md-5">
    ...
    $(function(){
      ...
      document.getElementById('filterKelas').addEventListener('change', function() {
          ...
          table.ajax.url("{{ route('penggunaan.index') }}?startDate=" + startDate + "&endDate=" + endDate + "&filterKelas=" + filterKelas).load();
      });
      ...
      $('#exportPenggunaan').click(function(e) {
        e.preventDefault();
        window.location = "{{ route('penggunaanExport') }}" + "?filterKelas=" + $("#filterKelas").val() + "&startDate=" + $("#startDate").val() + "&endDate=" + $("#endDate").val();
      });
