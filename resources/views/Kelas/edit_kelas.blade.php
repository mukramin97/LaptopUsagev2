...
@section('content')
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="{{ route('kelas.update',$editKelas->id) }}" method="post" id="edit_kelas"> {{ method_field('PUT') }}
            {{ csrf_field() }}

            <div class="form-group">
              <label for="nama_kelas">Nama Kelas</label>
              <input type="text" class="form-control" id="nama_kelas" name="nama_kelas" placeholder="Nama Kelas" value="{{ $editKelas->nama_kelas }}">
